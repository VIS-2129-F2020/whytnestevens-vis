...
Lastly, I tried my hand at some correlograms. To the extent that they worked or were accurate, I am not sure. However, I would like to come back to these types of charts in the future as I think they'd be useful in other data anaylses.




```{r}
ggcorr(person_data2, method = c("everything", "pearson")) 
```
...
ggcorrplot(corr, hc.order = TRUE, 
           ...
           title="Correlogram of person_data2", 
